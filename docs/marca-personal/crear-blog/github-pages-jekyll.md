...
{: .highlight }
- Crear cuenta en Github: Será nuestro servidor de hosting. Aquí alojaremos nuestra página.
- Crear la página a partir de template: El template que usaremos está guardado en los repositorios de github. Debemos clonarlo para crear nuestra página.
- Ajustar el pipeline en Github Actions: Ajustaremos el pipeline de release del repositorio para aplicar los cambios.
...
![verification 3](/docs/marca-personal/crear-blog/github-pages-jekyll/images/7.png)

## Crear página la partir de template
...
Agregauna descripción y público.
